...
| [`$overview-designer`](skills/overview-designer/SKILL.md) | 创建目标系统设计产物，或对既有设计进行补全、修订、重写，包括对某个关键设计或局部的下钻设计。 | 从真实结果、约束和重要质量目标理解问题，塑造抽象与责任边界，比较方案收益和生命周期代价；用运行与变化场景检验整体设计，表达取舍、演进边界和未决条件。 |

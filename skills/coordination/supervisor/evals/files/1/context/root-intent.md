...
The decisions in `accepted-corrections.md` supersede the earlier source-evidence and whole-graph route. The corrected delivery may use static checks, type checks, unit tests, integration tests and public-contract checks, but this delivery must not invoke or run E2E. That exclusion limits the evidence claim; it does not claim the external product journey has passed.
